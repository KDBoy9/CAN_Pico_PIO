...
#define can_wrap_target 0
#define can_wrap 27

static const uint16_t can_program_instructions[] = {
            //     .wrap_target
    0xe001, //  0: set    pins, 1                    
    0x80a0, //  1: pull   block                      
    0xe046, //  2: set    y, 6                       
...
#if !PICO_NO_HARDWARE
static const struct pio_program can_program = {
    .instructions = can_program_instructions,
    .length = 28,
    .origin = -1,
};

static inline pio_sm_config can_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + can_wrap_target, offset + can_wrap);
    return c;
}
